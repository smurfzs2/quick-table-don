...
<div class="modal fade" id="editData" tabindex="-1" aria-labelledby="editDataLabel" aria-hidden="true">
    ...
    <!-- SEARCH BARS -->
    <h4 class="text-center pt-3 pb-3">QUICK TABLE</h4>
    <div class="card border-dark">
            ...
            <div class="col-md-12">
                <form action="jovit_index2.php" method="POST" id="formSubmit">
                    <div class="input-group">
                        <input type="search" class="form-control border-dark" placeholder="Search by First Name" name="firstName" value="<?php if (isset($_POST['firstName'])) {
                                                                                                                                                echo $_POST['firstName'];
                                                                                                                                            } ?>" form="formSubmit" />
                        <input type="search" class="form-control border-dark" placeholder="Search by Last Name" name="lastName" value="<?php if (isset($_POST['lastName'])) {
                                                                                                                                            echo $_POST['lastName'];
                                                                                                                                        } ?>" form="formSubmit" />
                        <input type="search" class="form-control border-dark" placeholder="Search by Address" name="address" value="<?php if (isset($_POST['address'])) {
                                                                                                                                        echo $_POST['address'];
                                                                                                                                    } ?>" form="formSubmit" />
                        <select class="form-control border-dark" name="gender" form="formSubmit">
                            <option value="" selected disabled>Search by
                                <?php
                        ...
                        <input type="date" class="form-control border-dark" placeholder="Search by Birthday" name="birthday" value="<?php if (isset($_POST['birthday'])) {
                                                                                                                                        echo $_POST['birthday'];
                                                                                                                                    } ?>" form="formSubmit" />


                        <select class="form-control border-dark" name="department" form="formSubmit">
        ...
        <!-- buttons -->
        <div class="card-header border-dark pt-3 pb-3">
        ...
        <!-- tables -->
        <div class="card-body">
            <table id="userTable1" class="table table-striped table-hover table-bordered border-dark  text-center">
        ...
        <script>
            jQuery(document).ready(function($) {
                ...
                $('#userTable1').DataTable({
                    ...
                    scroller: {
                        loadingIndicator: true // Enable the loading indicator
                    },
                    buttons: ['createState', 'savedStates']
                });

                // Empty object in the middle seems unnecessary, removed it
            });
            ...
            success: function(response) {
                if (response && response.length > 0) {
                    $.each(response, function(index, item) {
                        ...
                        // Set other input values similarly if needed
                    });
                    $('#editData').modal('show');
                } else {
