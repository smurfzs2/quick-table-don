...
$query = "SELECT COUNT(CASE WHEN gender = '0' then 1 ELSE NULL END) AS male, COUNT(CASE WHEN gender = '1' then 1 ELSE NULL END) AS female, departmentName
          FROM hr_department INNER JOIN tbl_jovit ON hr_department.departmentId=tbl_jovit.departmentId 
